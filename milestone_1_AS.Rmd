...
<!-------------------------- Start your work below ---------------------------->
**I chose the vancouver_trees dataset because it has the data seems relatively clean, which will make the data easy to work with. I also personally like to work with this type of data because because it is similar to the kind of data I work with in my own degree as I work with plants.**
...
<!-------------------------- Start your work below ---------------------------->
**A question that I think is worth exploring is what is the relationship between the spread (longitude and latitude) and the different genera of trees.**
<!----------------------------------------------------------------------------->
...
**1.(Prompt number 1)I am interested in figuring out the distribution of tree diameters in this dataset, so I will do this with a density graph**
...
**4. (Prompt number 4) I will look at the relationship between average diameter and tree genus in Marpole neighborhood**
...
**6. (Prompt number 6) I will explore the relationship between tree genera and diameter in the Kensington-Cedar cottage by plotting a boxplot. I will also color by species**
...
**5.(prompt number 5)I will filter the dataset to find the genus with the largest average diameter.**
...
**1. What is the geographical distribution of the tree genus with the largest average diameter? (latitude and longitude)**
   ...
   With this plot, I am hoping to first filter the dataset to include only trees with the largest average diameter, and then     use a scatter plot to plot its geographical spread using latitude and longitude.
   
**2. What is the number of trees in Marpole and Kensington-Cedar cottage that have and don't have a root barrier?**

   With this plot, I am hoping to see if there is any relationship between the location of the trees and the presence or         absence of a root barrier. Maybe I will look into how this root barrier related to the diameter o height of the trees in      the area as well.

**3. What is the distribution of height ranges of trees in Marpole?**

   Since I have investigated the diameter of the tress primarily in this assignment, I want to explore the relationship          between tree genera and height range in the next one.

**4. What is the relationship between the date the tree was planted and the tree diameter?**

  I want to explore the relationship between the date the trees were planted to the diameter of the tree. To make the analyses   easier, I may filter for a particular location or tree genus.
<!----------------------------->
